...
@section('title', 'Modifier Ligne de Commande')

@section('content')
<div class="row mb-4">
    <div class="col-12">
        <h1><i class="bi bi-pencil"></i> Modifier une Ligne de Commande</h1>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('commandes.details.update', [$commande, $detail]) }}" method="POST">
            @csrf @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('type_bouteille_id') is-invalid @enderror" 
                            ...
                            @foreach($types as $type)
                                <option value="{{ $type->id }}" @selected($detail->type_bouteille_id == $type->id)
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('quantite_commandee') is-invalid @enderror" 
                               ...
                               value="{{ old('quantite_commandee', $detail->quantite_commandee) }}" onchange="updateMontant()">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('quantite_livree') is-invalid @enderror" 
                               ...
                               value="{{ old('quantite_livree', $detail->quantite_livree) }}">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('prix_unitaire') is-invalid @enderror" 
                               ...
                               value="{{ old('prix_unitaire', $detail->prix_unitaire) }}" onchange="updateMontant()">
                        @error('prix_unitaire')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('statut_ligne') is-invalid @enderror" 
                    ...
                    <option value="en_attente" @selected(old('statut_ligne', $detail->statut_ligne) == 'en_attente')>En Attente</option>
                    <option value="partielle" @selected(old('statut_ligne', $detail->statut_ligne) == 'partielle')>Partielle</option>
                    <option value="livree" @selected(old('statut_ligne', $detail->statut_ligne) == 'livree')>Livrée</option>
                    <option value="annulee" @selected(old('statut_ligne', $detail->statut_ligne) == 'annulee')>Annulée</option>
                </select>
                @error('statut_ligne')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="alert alert-info">
                <p class="mb-0"><strong>Montant de la Ligne:</strong> <span id="montant-display">{{ number_format($detail->montant_ligne, 2) }}</span> FCFA</p>
            </div>
