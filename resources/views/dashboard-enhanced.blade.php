                                ...
                                <div class="row g-1">
                                    <div class="col-6">
                                        <div class="progress" style="height: 20px;">
                                            <div class="progress-bar bg-primary" title="Pleines" style="width: {{ $stock['pleine'] > 0 ? min(($stock['pleine'] / max($stock['pleine'], $stock['vide'])) * 100, 100) : 0 }}%">
                                    ...
                                    <div class="col-6">
                                        <div class="progress" style="height: 20px;">
                                            <div class="progress-bar bg-secondary" title="Vides" style="width: {{ $stock['vide'] > 0 ? min(($stock['vide'] / max($stock['pleine'], $stock['vide'])) * 100, 100) : 0 }}%">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card border-0 shadow-sm">
                ...
                @if($recentPaiements->count() > 0)
                    <div class="card-footer bg-light">
                        <a href="#" class="btn btn-sm btn-outline-primary">Voir tous les paiements</a>
                    </div>
                @endif
            </div>
        </div>
